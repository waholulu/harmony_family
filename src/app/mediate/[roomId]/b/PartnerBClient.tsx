...
export default function PartnerBClient(props: { params: Promise<{ roomId: string }> }) {
  ...
  const handleSubmit = () => {
    ...
    sessionStorage.setItem(`harmony-mediation-b-${params.roomId}`, JSON.stringify(form));
    router.push(`/mediate/${params.roomId}/result`);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100 flex items-center justify-center p-4">
      <Card className="max-w-2xl w-full shadow-xl shadow-zinc-200/50">
        <CardHeader>
          <CardTitle className="text-2xl">B 的版本</CardTitle>
          <CardDescription>请独立写下你的版本。你的原文不会直接展示给对方。</CardDescription>
        </CardHeader>
